...
public class PoseEstimatorConstants {
    public static final Matrix<N3, N1> QUEST_STD_DEVS = VecBuilder.fill(0.002, 0.002, 0.0035);
    public static final Matrix<N3, N1> ODOMETRY_STD_DEVS = VecBuilder.fill(0.003, 0.003, 0.0002);

    public static final double VISION_STD_LINEAR = 0.017;
    public static final double VISION_STD_ANGULAR = 0.003;
